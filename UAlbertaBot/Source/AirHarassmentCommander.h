...
class AirHarassmentCommander
{
	...
	void				assignHarassmentSquads(std::set<BWAPI::Unit *> & combatUnits);
	void				assignIdleSquads(std::set<BWAPI::Unit *> & combatUnits);

	void				assignBaseAssault(std::set<BWAPI::Unit *> & unitsToAssign);
